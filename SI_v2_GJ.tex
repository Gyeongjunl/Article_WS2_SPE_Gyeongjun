...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{Figures/membrane2.pdf}
...
\begin{figure}[H]
  ...
  \caption{Optical image  under white light illumination of SiC membrnae at (a) 1000$^\circ$C and (b) at 25$^\circ$.}
